                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="">
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysqli_query($conn,"SELECT * FROM class_quiz 
                                                ...
                                                ORDER BY class_quiz_id DESC") or die(mysqli_error($conn));
                                            ...
                                            while($row = mysqli_fetch_array($query)){
                                                ...
                                                $grade = ($row1 && isset($row1['grade'])) ? $row1['grade'] : "";
                                            ?>
                                            <tr>
                                                ...
                                                <td width="200">
                                                    <?php if ($grade == ""){ ?>
                                                        <a data-placement="bottom" title="Take This Quiz" 
                                                           href="take_test.php?id=<?php echo $get_id; ?>&class_quiz_id=<?php echo $id; ?>&test=ok&quiz_id=<?php echo $quiz_id; ?>&quiz_time=<?php echo $quiz_time; ?>">
