<div class="span3" id="sidebar">
    ...
    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
        <li class=""><a href="dashboard_teacher.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Class</a></li>
        ...
        <li class=""><a href="teacher_backpack.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Backpack</a></li> 
        ...
        <li class="active"><a href="teacher_online.php"><i class="icon-chevron-right"></i><i class="icon-facetime-video"></i>&nbsp;Online Classroom</a></li>
